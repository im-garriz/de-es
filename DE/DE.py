# Differential evolution programmed in DifferentialEvolution.py
from DifferentialEvolution import run_DE
...
def main():
    """
    Runs the differential evolution NUMBER_OF_EXECUTIONS times and generates a
    ...
    for seed in random_seeds:
        ...
        # Run the algorithm
        convergence_parameters, logbook = run_DE()
